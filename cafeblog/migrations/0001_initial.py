...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Blog'
        db.create_table('cafeblog_blog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('administrator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='admin', to=orm['auth.User'])),
        ))
        db.send_create_signal('cafeblog', ['Blog'])

        # Adding M2M table for field authors on 'Blog'
        db.create_table('cafeblog_blog_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['cafeblog.blog'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('cafeblog_blog_authors', ['blog_id', 'user_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'Blog'
        db.delete_table('cafeblog_blog')

        # Removing M2M table for field authors on 'Blog'
        db.delete_table('cafeblog_blog_authors')
