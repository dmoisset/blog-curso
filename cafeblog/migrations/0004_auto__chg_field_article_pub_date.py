...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cafeblog_article', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Article.pub_date'
        db.alter_column('cafeblog_article', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(default=None))
