...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.creation_time'
        db.add_column('cafeblog_article', 'creation_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Article.last_modified'
        db.add_column('cafeblog_article', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.creation_time'
        db.delete_column('cafeblog_article', 'creation_time')

        # Deleting field 'Article.last_modified'
        db.delete_column('cafeblog_article', 'last_modified')
