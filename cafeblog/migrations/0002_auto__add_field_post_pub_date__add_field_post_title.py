...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cafeblog_post', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Post.title'
        db.add_column('cafeblog_post', 'title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 3, 1, 0, 0), max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.pub_date'
        db.delete_column('cafeblog_post', 'pub_date')

        # Deleting field 'Post.title'
        db.delete_column('cafeblog_post', 'title')
    ...
    models = {
        ...
        'cafeblog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 0, 0)'}),
